...
$result = mysqli_query($conn,"SELECT ksu_std_department,ksu_std_name,ksu_std_grade    FROM ksu_std_table where  ksu_std_department !=' ' order by ksu_std_department");  
 echo "<table border='1'>                   
 <tr>
...
?> 
<form enctype="multipart/form-data" method="post" action="ksu_select5aen.html" > 
