...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2021 at 03:26 PM
...
CREATE TABLE `store_information_1` (
  `Store_Name` varchar(12) CHARACTER SET latin1 NOT NULL,
  `Sales` int(1) NOT NULL,
  `Txn_Date` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `test_table03`
--
...
--
-- Dumping data for table `test_table03`
--

INSERT INTO `test_table03` (`student_no`, `student_name`) VALUES
('A0001', 'John Sieg'),
('A0002', 'Mike Unite'),
('A0003', 'John Miner'),
('A0004', 'Fire John');
...
--
-- Table structure for table `test_table04`
--
...
--
-- Dumping data for table `test_table04`
--

INSERT INTO `test_table04` (`student_no`, `student_name`) VALUES
('A0001', 'John Sieg'),
('A0002', 'Mike Unite'),
('A0003', 'John Miner'),
('A0004', 'Fire John');
