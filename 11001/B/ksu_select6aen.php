<?php
 ...
 $dept1=str_replace("'","''",$_REQUEST['dept1']); 
...
"SELECT ksu_std_name,ksu_std_grade
 FROM ksu_std_table
 where ksu_std_department = '$dept' and
       ksu_std_grade = '$dept1'
...
//use mysqli_fetch_array() takes the data from DB
 ...
 echo "</table>";
 echo  "共"$row_num."名學生"."<br/><br/>";
?> 
<form enctype="multipart/form-data" method="post" action="ksu_select6aen.html" > 
